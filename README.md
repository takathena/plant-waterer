...
3. open source
4. dashboard
    - automatic & manual Mode (real time 200ms - 500ms)
    - soil chart realtime
    - cross platform
    - customable design 
...
1. clone this repo to get the required assets (normal version)
```bash 
...
5. The dashboard display will look like ![](assets/screenshots/Screenshot%202025-11-22%20at%2021-37-00%20IoT%20Dashboard.png)
